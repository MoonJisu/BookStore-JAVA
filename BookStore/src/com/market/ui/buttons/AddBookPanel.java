...
import com.market.dao.BookDao; // DAO import 확인
...
public class AddBookPanel extends DefaultPanel {
	...
	public AddBookPanel() {
		...
		// 항목 addRow로 통일
		descField = addRow(formPanel, gbc, y++, "설명"); // y=6
	...
	private void chooseImage() {
		...
		// 부모 컴포넌트를 명시적으로 JFrame의 루트 창으로 설정하여 안정성 확보
		if (fc.showOpenDialog(JOptionPane.getRootFrame()) == JFileChooser.APPROVE_OPTION) { 
